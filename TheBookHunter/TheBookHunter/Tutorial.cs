...
namespace TheBookHunter
{
    public class Tutorial
    {
        ...
        public void Yes(Player player)
        {
            ...
            Console.ReadLine();
            Console.WriteLine("▶ 걸음을 멈춘 이안은 웃으며 당신을 돌아보았다.");
            Console.ReadLine();
            Console.WriteLine("\"음, 지루한 설명은 이쯤 해두면 될 것 같구만. 고생 많았소.\"");
            Console.ReadLine();
            Console.WriteLine("▶ 언제 폭삭 무너져도 이상하지 않을 고서점의 문이 끔찍한 소리를 내며 열렸다.");
            Console.ReadLine();
            Console.WriteLine("▶ 내부는 어두워서 보이지 않았지만 묵직한 공기의 울림이 느껴졌다. 바로 이곳이 지하묘지의 입구임을 당신은 알아챘다.");
            Console.ReadLine();
            Console.WriteLine("\"책 사냥꾼에게 중요한 것은 뭐니 뭐니 해도 경험 아니겠소?\"");
            Console.ReadLine();
            Console.WriteLine("▶ 문 앞에서 망설이는 당신에게 작은 도움을 주기 위해…… 이안은 당신의 등을 걷어찼다.");
            Console.ReadLine();
            Console.WriteLine("▶ 중심을 잃고 나동그라진 당신의 뒤로 문이 서서히 닫혔다.");
            Console.ReadLine();
            Console.WriteLine("\"자, 내려가시오! 그대에게 어떤 위험이 닥치든, 그 이야기 전해줄 이 하나 없는 곳으로!\"");
            Console.ReadLine();
